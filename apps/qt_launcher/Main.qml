        ...
        Item {
            GridLayout {
                ...
                AppButton {
                    ...
                    label: "Audio Viz"
                    accent: "#ff5090"
                    onClicked: launcher.launch("SDL_VIDEODRIVER=kmsdrm " + repo + "/apps/i2s-audio-viz/audio_viz -d hw:1,0 -c 2 -g 32 -w 1000 -f")
                }
                ...
                AppButton {
                    ...
                    label: "Audio Full"
                    accent: "#c050ff"
                    onClicked: launcher.launch("SDL_VIDEODRIVER=kmsdrm " + repo + "/apps/i2s-audio-viz/audio_viz_full -d hw:1,0 -c 2 -g 32 -w 1000 -f -l")
                }
            }
        }
